                  ...
                  {/* Plan */}
                   ...
                   <div className="mt-4">
                     <Link
                       ...
                       className="w-full inline-flex items-center justify-center text-sm text-blue-600 hover:text-blue-700 font-medium px-4 py-3 rounded-lg border border-blue-200 hover:bg-blue-50"
                     >
